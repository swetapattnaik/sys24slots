...
<c:if test="${!empty doctors1}">
	...
	<h1> Doctors Details</h1>
		...
		<tr>
			...
			<!-- 	<td><a href="Notification.html?ID=${patient.patientID}&date=${patient.appointmentDate}&Type=${patient.ailmentType}">Notification
...
<a href="Notification.html?ID=${patient.patientID}&date=${patient.appointmentDate}&Type=${patient.ailmentType}&docid=${appoint.doctorID}">Notification
